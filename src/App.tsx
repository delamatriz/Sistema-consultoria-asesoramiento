  ...
  return (
    ...
    <button onClick={onConsultas} style={{ ...styles.btnPrimary, marginBottom: '9px' }}>Ver todas las consultas</button>
      <div style={{ display: 'flex', gap: '8px', marginBottom: '30px', width: '100%' }}>
        <button onClick={onTeam} style={{ ...styles.btnSecondaryOutline, flex: 1, fontSize: '11px' }}>Gestión de equipo</button>
        <button onClick={onConfig} style={{ ...styles.btnSecondaryOutline, flex: 1, fontSize: '11px' }}>Configuración</button> 
        <button onClick={onBiblioteca} style={{ ...styles.btnSecondaryOutline, flex: 1, fontSize: '110px' }}>Biblioteca</button>
      </div>
