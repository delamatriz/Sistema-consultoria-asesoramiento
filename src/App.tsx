...
function ScreenQuienesSomos({ onBack }: any) {
  return (
    <div style={styles.container}>
      ...
      <button onClick={onBack} style={{ ...styles.btnLuxuryBack, marginTop: '30px' }}>Volver a mis consultas</button>
    </div>
  );
}
...
function ScreenHistorial({ currentUser, onSelect, onBack }: any) {
  ...
  return (
    <div style={styles.container}>
      ...
      <button onClick={onBack} style={{ ...styles.btnLuxuryBack, marginTop: '40px' }}>Volver a mis consultas</button>
    </div>
  );
}
...
function ScreenPerfil({ userProfile, onBack, onLogout }: any) {
  return (
    <div style={styles.container}>
      ...
      <button onClick={onBack} style={{ ...styles.btnLuxuryBack, marginTop: '15px' }}>Volver a mis consultas</button>
    </div>
  );
}
