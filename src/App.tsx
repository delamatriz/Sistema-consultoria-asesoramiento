...
export default function App() {
  ...
  const renderContent = () => {
    switch (view) {
      ...
      case 'user_opciones': return <ScreenOpciones caseId={selectedCaseId} onSelect={(service) => { setSelectedService(service); navigate('user_pago'); }} onBack={() => navigate('user_detalle')} />;
