      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginTop: '15px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div style={{ ...styles.cardInfo, border: THEME.border }}>
            ...
            {isDirectorView && caso && <button onClick={()=>generarPDFCaso(caso,actuaciones)} style={{marginTop:'15px',width:'100%',padding:'12px',backgroundColor:'#1D1D1F',color:'#fff',border:'none',borderRadius:'6px',fontSize:'13px',fontWeight:700,cursor:'pointer',borderRadius:'6px'}}>Descargar expediente PDF</button>}
