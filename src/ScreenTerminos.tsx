    ...
    <div style={{ maxWidth: '680px', margin: '0 auto', padding: '40px 20px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>1. Consulta Inicial gratuita</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>2. Alcance de la Consulta Inicial</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>3. Servicios profesionales contratados</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>4. Pagos</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>5. Confidencialidad</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>6. Propiedad intelectual</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>7. Jurisdiccion</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>8. Limitacion de responsabilidad</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>9. Proteccion de datos personales</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>10. Modificacion de los terminos</p>
        ...
        <div style={{ backgroundColor: '#FFFFFF', borderRadius: '12px', padding: '25px', border: '1px solid #E5E5E7' }}>
          <p style={{ fontSize: '11px', fontWeight: 900, letterSpacing: '0.12em', color: '#1D1D1F', margin: '0 0 10px 0', textTransform: 'uppercase', borderLeft: '5px solid #B21F24', paddingLeft: '10px' }}>11. Aceptacion</p>
